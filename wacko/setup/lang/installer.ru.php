...
"meta2" => "Описание",
"ForDetailsSee" => "Не побоимся повториться, см. <a href=\"http://wackowiki.com/WackoDokumetacija/Ustanovka\" target=\"_blank\">WackoWiki:WackoДокументация/Установка</a>",
...
"baseDesc" => "Базовый URL вашей инсталляции WackoWiki. Имена страниц присоединяются к нему, поэтому он должен включать параметр \"?wakka=\", если Вы почему-либо не можете использовать mod_rewrite.",
"base" => "Базовый URL",
...
"Doubles" => "Попробуйте <a href=\"http://wackowiki.com/WackoDokumentacija/CleanupScript\" target=\"_blank\">WackoWiki:WackoДокументация/CleanupScript</a>, это ускорит вашу Ваку.",
