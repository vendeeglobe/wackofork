...
"databaseDriverDesc" => "The database driver you want to use.  You must choose a legacy driver if you do not have PHP5.1 (or greater) and <a href=\"http://de2.php.net/pdo\" target=\"_blank\">PDO</a> installed.",
"databaseDriver" => "Database Driver",
"databasePortDesc" => "The port number your database server is accessable through, leave it blank to use the default port number.",
"databasePort" => "Database Port",
"databaseHostDesc" => "The host your database server is running on. Usually \"localhost\" (ie, the same machine your WackoWiki site is on).",
"databaseHost" => "Database host",
"dbDesc" => "The database WackoWiki should use. This database needs to exist already once you continue!",
"db" => "Database name",
"databasePasswDesc" => "Name and password of the user used to connect to your database.",
"databaseUser" => "User name",
"databasePassw" => "Password",
"no database driver selected" => "No database driver has been selected, please pick one from the list.",
"NoDatabaseDriverDetected" => "No database driver has been detected, please enable either the mysql, mysqli or pdo extension in your php.ini file.",
