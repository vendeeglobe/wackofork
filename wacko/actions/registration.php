...
//  else
  ...
  <table border="0" align="center">
    <tr>
      <td colspan="2" align="center"><strong><?php echo $this->FormatResourceValue("RegistrationWelcome"); ?></strong><br /><br /></td>
    </tr>
    <?php
    if ($error)
    {
    ...
    <tr>
      ...
      <td><input name="name" size="27" value="<?php echo htmlspecialchars($name); ?>" /></td>
    </tr>
    <tr>
