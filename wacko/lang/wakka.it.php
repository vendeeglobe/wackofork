...
$wakkaResource = array(
  ...
  "RegistrationName" => " Assegnati un ((WackoWiki:WackoDocumentation/WhatIsNameSurname NomeCognome))",
  ...
  "LoginName" => "((WackoWiki:WackoDocumentation/WhatIsNameSurname NomeCognome))",
  ...
  "MailHello" => "Salve, ",
  "MailGoodbye" => "Saluti, ",
  "A watched Page changed!" => "Pagina modificata ",
  "Someone changed this page:" => " cambiata la pagina da te controllata: ",
  ...
  "NoPagesFound" => "<em>Nessuna pagina trovata.</em>",
  ...
  "MustBeWikiName" => "Il nome-utente deve essere ((http://wackowiki.com/wackodocumentation/WikiName NomeWiki)) configurato!",
  ...
  "Comment for watched page" => "Nuovo commento sulla pagina ",
  "Someone commented" => " ha commentato la pagina che stai osservando: ",
  "AlertReferringPages" => "La pagina è richiamata da queste altre pagine",

  "EditIcon" => "(edizione)",
  "LinksTree:Level>4 warning" => " L'albero dei link supporta al massimo 4 livelli",
  ...
  "EmailNotConfirmed" => "L'email non può essere confermata. Può essere il codice sbagliato?",
