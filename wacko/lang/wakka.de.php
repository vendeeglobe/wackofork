...
$wakkaResource = array(
  ...
  "RegistrationName" => "((WackoWiki:WackoDocDeutsch/VorUndNachname Benutzername))",
  ...
  "LoginName" => "((WackoWiki:WackoDocDeutsch/VorUndNachname Benutzer))",
  ...
  "MailHello" => "Hallo, ",
  "MailGoodbye" => "MfG, ",
  "A watched Page changed!" => "Seite wurde geändert ",
  "Someone changed this page:" => " änderte diese von Dir beobachtete Seite: ",
  "ActionDenied" => "Hier sind keine Aktionen erlaubt.",
  "TOCTitle" => "Inhalt ",
  "SearchButtonText" => "Suche",
  "OuterLink2" => "externer Verweis (in neuem Fenster)",
  "MailLink" => "Schreibe E-Mail (Mailprogramm wird gestartet)",
  ...
  "EditTip"   => "Klicke hier um Seite zu editieren." ,
  "EditText"    => "Editieren" ,
  "RevisionTip"   => "Klicke hier um Seitenversionen anzusehen",
  "RevisionXMLTip"  => "Klicke hier um Seitenversionen im XML-Format anzusehen.",
  ...
  "OwnerDon'tChange"  => "keine Änderung",
  ...
  "CommentAccessDenied"   => "<em>Du hast kein Kommentarrecht auf diese Seite.</em>",
  ...
  "Domains/SitesPages(Global)" =>"Domänen/Sites, die auf dieses WackoWiki verlinkt haben (<a href=\"%1\">zeige URLs</a>):",
  "ViewReferringSites"  =>"<a href=\"%1\">zeige nur auf %2 referenzierende Sites</a> ",
  "ViewReferrersFor"  =>" <a href=\"%1\">zeige nur Referenzen auf %2</a>",
  "ViewReferringSites(Global)"=>"<a href=\"%1\">zeige global referenzierende Sites</a>",
  "ViewReferrersFor(Global)"=>"<a href=\"%1\">zeige globale Referenzen</a>",
  "NoneReferrers"   =>"<em>keine</em>",
  ...
  "NoPagesFound" => "<em>keine</em>",
  "MyChangesTitle1" => "von Dir geänderte Seiten, sortiert nach dem Zeitpunkt der letzten Änderung",
  "MyChangesTitle2" => "von Dir geänderte Seiten mit dem Zeitpunkt der letzten Änderung",
  "OrderABC" => "alphabetisch sortiert",
  "OrderDate" => "nach Datum sortiert",
  "OrderChange" => "sortiert nach Änderung",
  ...
  "Email" => "E-Mailadresse",
  "MustBeWikiName" => "Benutzername muss im ((http://wackowiki.com/WackoDocDeutsch/VorUndNachname WikiName))-Format sein!",
  ...
  "AddToBookmarks" => "Füge aktuelle Seite zu Schnelllinks hinzu",
  "YourBookmarks" => "Deine Schnelllinks",
  ...
  "ReallyDelete" => "Willst Du wirklich diese Seite löschen?<br />Diese Aktion kann nicht rückgängig gemacht werden!<br /><br />WARNUNG: Mit dieser Seite werden alle zur Seite gehörigen Versionen, Kommentare, Berechtigungen und Verweise gelöscht.",
  "RemoveButton" => "Ja, löschen!",
  "Comment for watched page" => "neuer Kommentar zur Seite ",
  "Someone commented" => " kommentierte die von Dir beobachtete Seite: ",
  "AlertReferringPages" => "Auf diese Seite wird von folgenden Seiten verwiesen",

  "EditIcon" => "(Editiere)",
  "LinksTree:Level>4 warning" => "die Baumansicht unterstützt nicht mehr als 4 Ebenen",
  ...
  "RemoveFromBookmarks" => "Entferne aus den Lesezeichen",
  ...
  "EmailNotConfirmed" => "E-Mail konnte nicht bestätigt werden. Vielleicht ein falscher Code?",
  ...
  "ForgotField" => "((WackoWiki:WackoDocDeutsch/VorUndNachname VorUndNachname)) oder E-Mail",
  "SendButton" => "Senden!",
  ...
  "UploadRemovedFromDB"    => "Datei aus der Datenbank löschen",
  ...
  "PleaseLogin" => "((Settings Bitte hier registrieren))",
