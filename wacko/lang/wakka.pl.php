...
$wakkaResource = array(
  ...
  "RegistrationName" => "Wprowad¼ swoje ((WackoWiki:WackoDocEnglish/WhatIsNameSurname ImiêNazwisko))",
  ...
  "LoginName" => "Twoje ((WackoWiki:WackoDocEnglish/WhatIsNameSurname ImiêNazwisko))",
  "LoginPassword" => "Has³o",
  "LoginButton" => "Zaloguj!",
  // other
  ...
  "MailHello" => "Cze¶æ, ",
  "MailGoodbye" => "Twój, ",
  "A watched Page changed!" => "Zawarto¶æ strony zmieni³a siê ",
  "Someone changed this page:" => " zmieni³ zawarto¶æ obserwowanej przez Ciebie strony: ",
  ...
  "EditRe-EditButton" => "Edytuj ponownie",
  ...
  "Comparison" => "<b>Porównianie zmian zawarto¶ci strony %3. Wersje z: %1 oraz %2</b>",
  ...
  "ExternalPages(Global)" => "Lista wszystkich witryn zawieraj±cych odno¶nik do naszego systemu Wiki. (Wy¶wietl tylko  <a href=\"%1\">domeny</a>):",
  "Last24Hours" => "dane z ostatnich 24h",
  "LastDays" => "dane z ostatnich %1 dni",
  "Domains/SitesPages" => "Witryny lub domeny zawieraj±ce odno¶nik do strony: %1 (%2)  (<a href=\"%3\" >Wy¶wietl listê adresów</a>):",
  "Domains/SitesPages(Global)" => "Lista wszystkich witryn zawieraj±cych odno¶nik do naszego systemu Wiki. (Poka¿ listê <a href=\"%1\">adresów</a>):",
  ...
  "ViewReferringSites(Global)" => "Poka¿ wszystkie odsy³acze z podzia³em na: <a href=\"%1\">domeny</a>",
  "ViewReferrersFor(Global)" => "<a href=\"%1\">witryny</a>.",
  ...
  "Email" => "Adres e-mail",
  "MustBeWikiName" => "Nazwa u¿ytkownika musi byæ w formacie ((WackoWiki:WackoDocPolish/NazwaWiki NazwyWiki))!",
  ...
  "ReallyDelete" => "Czy na pewno USUN¡Æ tê stronê?<br />Tej czynno¶ci nie mo¿na cofn±æ!<br /><br />OSTRZE¯ENIE: Usuniêcie tej strony spowoduje usuniêcie wszystkich zachowanych wersji strony, komentarzy, odsy³aczy i list dostêpu.",
  "RemoveButton" => "Usuñ na pewno!",
  "Comment for watched page" => "Nowy komentarz na stronie ",
  "Someone commented" => " skomentowa³ obserwowan± przez Ciebie stronê: ",
  "AlertReferringPages" => "Do tej strony odwo³uj± siê nastêpuj±ce dokumenty",

  "EditIcon" => "(edytuj)",
  "LinksTree:Level>4 warning" => "Drzewo odno¶ników nie obs³uguje zagnie¿d¿ania powy¿ej 4 poziomów",
  "LinksTree:Title" => "Drzewo odno¶ników",
  ...
  "AlredyNamed" => "<em>Ta strona ju¿ ma nazwê <strong>%1</strong>.</em>",
  ...
  "Mail.Welcome" => "Dziêkujemy. Rejestracja przebieg³a pomy¶lnie ",
  "Mail.Registered" => "Dziêkujemy! Twoja rejestracja zosta³a zakoñczona pomy¶lnie<br />Nazwa u¿ytkownika: %2<br />Aby w³±czyæ mo¿liwo¶æ otrzymywania powiadomieñ z tej strony nale¿y potwierdziæ swój adres e-mail. W tym celu nale¿y po³±czyæ siê z <a href=%3>t± stron±</a>.",
  "Mail.Verify" => "Kto¶ (prawdopodobnie Ty) zamierza otrzymywaæ powiadomienia do %1 na ten adres e-mail.<br /> Twoja nazwa u¿ytkownika:  %2<br />Je¿eli chcesz otrzymywaæ od nas powiadomienia niezbêdne jest potwierdzenie. W tym celu nale¿y po³±czyæ siê z <a href=%3>t± stron±</a>.",
  "Mail.Confirm" => "Weryfikacja adresu e-mail",
  "EmailConfirmed" => "Adres e-mail zosta³ potwierdzony. Dziêkujemy!",
  "EmailNotConfirmed" => "Adres e-mail nie móg³ zostaæ potwierdzony. Nale¿y sprawdziæ poprawno¶æ wprowadzonego kodu.",
  ...
  "ForgotField" => "((WackoWiki:WackoDocEnglish/WhatIsNameSurname NazwaWiki)) lub e-mail",
  "SendButton" => "Wy¶lij!",
  ...
  "Mail.ForgotSubject" => "Ponowienie has³a dla ",
  "Mail.ForgotMessage" => "Kto¶ (prawdopodobnie Ty) zapomnia³ swojego has³a do %1<br />Twój login: %2<br />Kliknij na <a href=\"%3\">%3</a> albo skopiuj adres do przegl±darki, aby zmieniæ swoje has³o.",
