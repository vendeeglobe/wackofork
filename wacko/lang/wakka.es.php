...
$wakkaResource = array(
  ...
  "RegistrationName" => "Date un ((WackoWiki:WackoDocumentation/WhatIsNameSurname NombreDeUsuario))",
  ...
  "LoginName" => "((WackoWiki:WackoDocumentation/WhatIsNameSurname NombreDeUsuario))",
  "LoginPassword" => "Contraseña",
  "LoginButton" => "Conectar",
  // other
  "TopicSearchText" => "Buscar solo en titulos",
  "MsWordVersion" => "Version para Microsoft Word",
  "MailHello" => "Hola, ",
  "MailGoodbye" => "Adios, ",
  "A watched Page changed!" => "Página modificada ",
  "Someone changed this page:" => " ha cambiado esta página, que tu estas vigilando:: ",
  ...
  "OwnerDon'tChange"  => "No cambiar nada",
  ...
  "NoPagesFound" => "<em>No he encontrado ninguna página.</em>",
  "NotLoggedInThusOwned" => "<em>No estas conectado, por lo que no puedo mostrar la lista de tus páginas.</em>",
  ...
  "Email" => "Email",
  "MustBeWikiName" => "El usuario debe tener un formato ((http://wackowiki.com/wackodocumentation/WikiName WikiName))!",
  ...
  "EmailNotConfirmed" => "El Email no se ha podido confirmar. Codigo incorrecto?",

  "ForgotComment" => "Introduce tu login o e-mail,\n y te enviaremos un e-mail con instrucciones.",
  "ForgotMain" => "Contraseña olvidada?",
  "ForgotField" => "((WackoWiki:WackoDocumentation/WhatIsNameSurname NameUsuario)) o e-mail",
  "SendButton" => "Enviar!",
  ...
  "UploadMaxSizeReached" => "La talla del archivo es mayor que el límite!",
  ...
  "UploadRemovedFromFS"    => "Archivos eliminados del sistema de fichieros",
  ...
  "lockicon"  => '<img src="{theme}icons/lock.gif" align="middle" hspace="2" alt="Accesso negado" border="0" />',
  "keyicon"   => '<img src="{theme}icons/key.gif" align="middle" hspace="2" alt="Página con acceso especial" border="0" />',
  "wantedicon" => '?',
);
